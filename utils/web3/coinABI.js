  ...
  coin_vault_machine_USDT: [
    {
      ...
      constant: true,
      inputs: [{ internalType: 'uint256', name: '_pendingBalance', type: 'uint256' }, {
        internalType: 'address',
        name: 'user',
        type: 'address'
      }],
      name: 'cal_out_pending',
      outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
      payable: false,
      stateMutability: 'view',
      type: 'function'
      ...
      name: 'global_',
      outputs: [{ internalType: 'uint256', name: 'total_stake', type: 'uint256' }, {
        internalType: 'uint256',
        name: 'total_out',
        type: 'uint256'
      }, { internalType: 'uint256', name: 'earnings_per_share', type: 'uint256' }],
      payable: false,
      stateMutability: 'view',
      type: 'function'
    }, {
      ...
      outputs: [{ internalType: 'uint256', name: 'stake', type: 'uint256' }, {
        ...
        name: 'payout',
        type: 'uint256'
      }, { internalType: 'uint256', name: 'total_out', type: 'uint256' }],
      payable: false,
      stateMutability: 'view',
      type: 'function'
    }, {
  ...
  abi_machine_strategy: [
    {
      ...
      constant: false,
      inputs: [{ internalType: 'address', name: '_burnAddress', type: 'address' }],
      name: 'setBurnAddress',
      outputs: [],
      payable: false,
      stateMutability: 'nonpayable',
